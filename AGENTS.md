...
Current production version: v0.19.12 "ThreeD Admin Model Workspace" (package `0.19.12`, commit `80c6a1d`). Successful production deployment is User-confirmed. See `docs/releases/v0.19.12.md`.
...
- Current App production checkpoint: v0.19.12 "ThreeD Admin Model Workspace". The latest ThreeD MQTT safety boundary remains v0.18.3b through Phase 4L-K.
