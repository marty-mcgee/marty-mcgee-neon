...
Current production version: v0.19.11 "ThreeD Model Management" (package `0.19.11`, commit `9cdc78e`). Successful production deployment is User-confirmed. See `docs/releases/v0.19.11.md`.
...
- Current App production checkpoint: v0.19.11 "ThreeD Model Management". The latest ThreeD MQTT safety boundary remains v0.18.3b through Phase 4L-K.
