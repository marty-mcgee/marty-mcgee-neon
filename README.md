...
| v0.18.5b | Phase 5B — Target-relative character navigation | Release candidate: tested client lifecycle transitions, camera-independent FarmBot approach controls, and aligned target focusing. It adds no command delivery or physical behavior. |
