...
> **Current production version:** `v0.19.8b "ThreeD Model Administration, Model File Management, Model Workspaces, Model Texture Dependencies"` (`package.json` version `0.19.8-beta`)
