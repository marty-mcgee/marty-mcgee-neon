...
> **Current production release:** `v0.19.25 — Multimedia Speech: Saved Version Track Publishing`, deployment User-confirmed. See the [release notes](docs/releases/v0.19.25.md).

> **Release candidate:** `v0.19.26 — Music + Multimedia Admin Page Blueprints`, package `0.19.26`. Local checkpoint User-accepted; manual build and deployment pending. See the [release notes](docs/releases/v0.19.26.md).
