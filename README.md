...
> **Current production release:** `v0.19.26 — Music + Multimedia Admin Page Blueprints`, deployment User-confirmed. See the [release notes](docs/releases/v0.19.26.md).

> **Release candidate:** `v0.19.27 — Admin Navigation + Model Animation Previews`, package `0.19.27`. Local checkpoint User-accepted; manual build and deployment pending. See the [release notes](docs/releases/v0.19.27.md).
