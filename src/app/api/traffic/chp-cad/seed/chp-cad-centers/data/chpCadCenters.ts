// src/lib/data/trafficChpCenters .ts
export const CHP_CAD_CENTERS = [
  ...
  { centerCode: 'KNG', centerName: 'Kings', county: 'Kings', region: 'Central' },
  { centerCode: 'MER', centerName: 'Merced', county: 'Merced', region: 'Central' },
  { centerCode: 'MTY', centerName: 'Monterey', county: 'Monterey', region: 'Central' },
  ...
  { centerCode: 'TUL', centerName: 'Tulare', county: 'Tulare', region: 'Central' },
  ...
  { centerCode: 'LAKE', centerName: 'Lake', county: 'Lake', region: 'Northern' },
