  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
        ...
        <Card><CardContent className="p-3"><div className="flex justify-between"><div><p className="text-xs text-muted-foreground">Total Acres</p><p className="text-2xl font-bold text-amber-600 dark:text-amber-400">{totalAcres}</p></div><TrendingUp className="w-5 h-5 text-muted-foreground" /></div></CardContent></Card>
