...
import { MusicLinkType } from '@/lib/types/music';
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Manage your music links and social presence</p>
        </div>
        <Button onClick={() => {
          resetForm();
          setIsDialogOpen(true);
          ...
          <div className="space-y-3">
            ...
            {links.length === 0 && (
              <p className="text-center text-muted-foreground py-8">
                No links yet. Click "Add Link" to add your first link.
              </p>
            )}
          </div>
        </CardContent>
