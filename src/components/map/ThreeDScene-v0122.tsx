...
// ✅ Marker geometry mapping - UPDATED to match your data types (plural)
...
// ✅ Marker colors by type - UPDATED to match your data types (plural)
const MARKER_COLORS = {
  planting: '#4CAF50',
  bed: '#FF9800',
  farmbot: '#9C27B0',
...
// ✅ ThreeD Marker with hover popup - FIXED: Use plural forms to match your data
function ThreeDMarkerComponent({ marker, onClick, isSelected }: any) {
  ...
  const getShape = () => {
    const s = size;
    switch (marker.type) {
      // ✅ Changed to match your actual data types (plural)
      case 'beds':
