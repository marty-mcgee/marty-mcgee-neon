// components/admin/multimedia/links/LinkForm.tsx
'use client';
...
import { MusicLinkType, MusicLinkStatus, MusicLink } from '@/libraries/types/multimedia';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const url = existingLink 
        ? `/api/multimedia/links?id=${existingLink.id}` 
        : '/api/multimedia/links';
