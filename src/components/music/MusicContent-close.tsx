// components/music/MusicContent.tsx - WITH TRACKS ATTACHED TO ALBUMS
'use client';
...
export default function MusicContent() {
  ...
  // ✅ Fetch tracks for a specific album and update the albums array
  ...
  // ✅ Handle album selection - fetch tracks and update album
