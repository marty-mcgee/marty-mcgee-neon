// src/components/multimedia/NowPlayingBar.tsx
'use client';

import { useEffect, useRef, useState } from 'react';
import { useMusicPlayer } from '@/libraries/stores/music-player-store';
// import { WaveformVisualizer } from '@/components/multimedia/WaveformVisualizer';
...
import { formatTime, cn } from '@/libraries/utils';
        ...
        <div className={cn(
          ...
          <div className="flex h-16 items-center justify-between px-4 text-sm text-muted-foreground">
            ...
            <Button 
              variant="ghost" 
              size="sm" 
              onClick={() => window.location.href = '/dashboard/multimedia'}
            >
              Browse Music
            </Button>
          </div>
  ...
  return (
    <>
      ...
      <div className={cn(
        ...
        <div className="w-full px-4 h-20 flex items-center gap-4">
          {/* Track Info */}
