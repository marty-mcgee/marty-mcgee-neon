...
//   updatedAt: timestamp('updated_at').defaultNow(),
// }, (table) => ({
//   userIdIdx: index('idx_user_account_user_id').on(table.userId),
//   providerIdx: index('idx_user_account_provider').on(table.provider),
//   providerAccountIdIdx: index('idx_user_account_provider_account_id').on(table.providerAccountId),
//   compositeProviderIdx: uniqueIndex('idx_user_account_provider_composite').on(table.provider, table.providerAccountId),
// }));
...
//   tokenIdx: uniqueIndex('idx_user_session_token').on(table.token),
//   expiresAtIdx: index('idx_user_session_expires_at').on(table.expiresAt),
// }));
...
//   updatedAt: timestamp('updated_at').defaultNow(),
// }, (table) => ({
//   userIdIdx: index('idx_user_verification_user_id').on(table.userId),
//   tokenIdx: uniqueIndex('idx_user_verification_token').on(table.token),
//   expiresAtIdx: index('idx_user_verification_expires_at').on(table.expiresAt),
// }));
