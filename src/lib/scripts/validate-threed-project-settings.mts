...
const pageSource = ts.createSourceFile('page.tsx', readFileSync(new URL('../../app/dashboard/map/page.tsx', import.meta.url), 'utf8'), ts.ScriptTarget.Latest, true, ts.ScriptKind.TSX);
