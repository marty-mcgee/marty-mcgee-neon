...
import {
  ...
  multimediaMedia,
  multimediaTracks,
} from '@/libraries/schema/multimedia';
import {
  threedBeds,
  threedCharacters,
  threedFarmbots,
...
export type ProjectModuleType = 'multimedia' | 'threed' | 'traffic';
...
export const ASSIGNABLE_ASSET_REGISTRY: Record<string, AssignableAssetDefinition> = {
  multimedia_albums: {
    moduleType: 'multimedia', policy: 'ownerOnly', table: multimediaAlbums,
    idColumn: multimediaAlbums.id, userIdColumn: multimediaAlbums.userId,
  },
  multimedia_tracks: {
    moduleType: 'multimedia', policy: 'ownerOnly', table: multimediaTracks,
    idColumn: multimediaTracks.id, userIdColumn: multimediaTracks.userId,
  },
  multimedia_links: {
    moduleType: 'multimedia', policy: 'ownerOnly', table: multimediaLinks,
    idColumn: multimediaLinks.id, userIdColumn: multimediaLinks.userId,
  },
  multimedia_media: {
    moduleType: 'multimedia', policy: 'ownerOnly', table: multimediaMedia,
    idColumn: multimediaMedia.id, userIdColumn: multimediaMedia.userId,
  },
