// src/libraries/services/CHPCADPoller.ts
import axios from 'axios';
import * as cheerio from 'cheerio';
import { db } from '@/libraries/db/client';
import { trafficChpCadIncidents, trafficChpCenters } from '@/libraries/schema';
import { eq, sql } from 'drizzle-orm';
// import { getCityCoordinates } from '@/libraries/utils/cityGeocoder';
