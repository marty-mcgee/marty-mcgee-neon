// src/libraries/services/CalFirePoller.ts - Updated to fetch both active and inactive

import { db } from '@/libraries/db/client';
import { trafficCalfireIncidents } from '@/libraries/schema';
...
export class CalFirePoller {
  ...
  // src/libraries/services/CalFirePoller.ts - Updated fetchIncidents method
  ...
  // src/libraries/services/CalFirePoller.ts - Add this new method
