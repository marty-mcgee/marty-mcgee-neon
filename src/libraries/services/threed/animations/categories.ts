...
import { threedAnimationActionSlots as slots, threedAnimationCategories as categories, threedAnimationCategoryAssignments as assignments, threedAnimations as clips } from '@/libraries/schema/threed';
