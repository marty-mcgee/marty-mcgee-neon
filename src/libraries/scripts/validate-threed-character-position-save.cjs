...
const savePosition = (ok) => callback('src/app/dashboard/scene/page.tsx', 'handleUpdateCharacterPosition', {
...
const handleLivePosition = callback('src/app/dashboard/scene/page.tsx', 'handleControlChange', {
