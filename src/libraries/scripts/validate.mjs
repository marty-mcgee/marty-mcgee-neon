...
const tasks = {
  ...
  'threed-model-preview-batch': [ts('validate-model-texture-readiness.mts'), node('validate-model-preview-batch.cjs'), ['node', '--import', 'tsx', `${scripts}/validate-model-preview-requirements.mts`]],
