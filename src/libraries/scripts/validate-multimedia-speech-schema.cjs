...
const dependencies = {
  ...
  '../project': {
    project: pg.pgTable('project', { id: pg.serial('id').primaryKey() }),
    projectMultimedia: pg.pgTable('project_multimedia', { id: pg.serial('id').primaryKey() }),
  },
};
const exportsObject = {};
vm.runInNewContext(ts.transpileModule(fs.readFileSync('src/libraries/schema/multimedia/index.ts', 'utf8'), {
