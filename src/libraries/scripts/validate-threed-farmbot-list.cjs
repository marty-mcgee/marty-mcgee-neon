...
const parser = load('src/libraries/services/threed/farmbot/farmbot-list-query.ts', {});
...
const api = load('src/app/api/threed/farmbots/route.ts', {
  '@/libraries/services/threed/farmbot/farmbot-list-query': parser,
  '@/libraries/services/threed/farmbot/sanitize': load('src/libraries/services/threed/farmbot/sanitize.ts', { 'server-only': {} }),
