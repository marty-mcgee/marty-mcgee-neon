...
const parser = load('src/libraries/services/threed/characters/character-list-query.ts', {});
...
const api = load('src/app/api/threed/characters/route.ts', {
  ...
  '@/libraries/services/threed/characters/character-library-access-core': load('src/libraries/services/threed/characters/character-library-access-core.ts', {}),
