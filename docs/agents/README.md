...
The current production checkpoint is [v0.19.17](../releases/v0.19.17.md), commit `e16e2e4`, User-confirmed. Package `0.19.17`; documentation and version correction deployed in `edefa4d`, User-confirmed. Preserve the anchored Project authority menu and activity overlays without Canvas resizing, plus existing Character/Model assignments, preview and camera preferences. Separate local build result was not reported. The v0.19.18 candidate adds Animation Mapping Presets, Categories and controlled Character navigation; see [release gates and validation](../releases/v0.19.18.md). Production remains v0.19.17 until user confirmation. Broader Garden behavior and world-action UX remain deferred.
