...
Current production is v0.18.9b **ThreeD Project Marker CRUD and Physics Synchronization**, using package version `0.18.9-beta`. No later release candidate is designated. The latest ThreeD MQTT safety boundary remains v0.18.3b through Phase 4L-K.
