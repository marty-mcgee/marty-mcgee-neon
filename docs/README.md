...
Current production is v0.18.9b **ThreeD Project Marker CRUD and Physics Synchronization**. The prepared release candidate is v0.18.9c **ThreeD Project Header and DetailsCard UI**, using package version `0.18.9-centaur`. The latest ThreeD MQTT safety boundary remains v0.18.3b through Phase 4L-K.
